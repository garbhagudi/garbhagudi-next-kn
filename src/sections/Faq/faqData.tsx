export const maleInfertility = [
  {
    ...
    contents: (
      <div>
        ...
        such as alcohol use, smoking, weight gain, and emotional stress.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        <br />
        In some cases, the doctor will recommend that the couple seek the
        assistance of assisted reproductive technologies (ART), such as IVF (in
        vitro fertilization). ART does not cure or treat the cause of
        infertility but can help couples achieve a pregnancy, even if the man's
        sperm count is meagre
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    contents: (
      <div>
        ...
        the inability of a man to achieve or maintain an erection. At the same
        time, premature ejaculation could be described as recurrent ejaculation
        with minimal stimulation. However, men experiencing fertility problems
        may be potent, and men with erectile dysfunction may still be fertile.
      </div>
    ),
  },
];
...
export const femaleInfertility = [
  {
    ...
    contents: (
      <div>
        ...
        third is due to female problem & third are a combination or unknown
        reasons. When the infertility is from the feminine partner, it’s
        considered female infertility.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        being infertile increases as a lady grows old.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        <article>
          ...
          <p className="text-md my-2">
            Infertility due to tubal factors may be due to any pelvic disease,
          ...
          <p className="text-md my-2">
            Women are born with all the eggs they will have, and in some, this
            supply can run out early before menopause. Some eggs may have
            incorrect monomers that cannot fertilize or grow into a healthy
            fetus. The quality of the egg deteriorates as a lady gets older.
          </p>
        </article>
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        and pinpoint the cause & guide you towards the possible treatment
        options. The cause of infertility determines the preferred treatment
        mode.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        ovulatory condition or an easy surgery to correct a structural
        abnormality (polyps or solitary fibroids), the outlook is usually
        positive. Ask your fertility doctor about your case history, risk
        factors, and underlying medical issues to learn more about your
        prognosis. <br />
        <br /> Medical science has made tremendous progress in reproductive
        health today, and there is a solution to almost all fertility challenges
        today. You need to visit the right hospital.
      </div>
    ),
  },
];
...
export const ivfProcedures = [
  {
    ...
    contents: (
      <div>
        ...
        may increase her chances of becoming pregnant. IUI is used to treat
        infertility related to various reasons, as long as at least one patent
        fallopian tube is present. It is also often used as an
        intermediate-level and cost-effective intervention before in vitro
        fertilization (IVF).{" "}
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        cervix into the uterus. The specimen is injected, and the catheter and
        the speculum are removed. It can cause discomfort, mainly when the
  ...
  },
  {
    ...
    contents: (
      <div>
        ...
        1 cycle is recommended to increase the chances of pregnancy.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        medications is about 10-20% successful.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        very few associated risks. However, cramping or spotting may occur
  ...
  },
  {
    ...
    contents: (
      <div>
        ...
        female, and at the same time, sperms are collected from the male
        partner. The eggs and sperms collected are made to fertilize in the
        laboratory, and the fertilized egg (embryo) is then implanted in the
        woman’s womb to make her conceive.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        patient and, if the case is less complicated, the success rate rises
        from 80 to 90 percent. If the issue is highly complex, it may drop 30-40
        percent.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        womb. It is one of the most cost-effective and successful treatments for
        infertile men.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        facilitate easy implantation of the embryo inside the womb.
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        being placed in the womb. The embryo gains many cells due to being
        developed for so many days. The embryos developed for 4-6 days are much
        more advanced than those developed for just three days, thus having
  ...
  },
  {
    ...
    contents: (
      <div>
        ...
        doctors will ask you to undergo checkups. Based on the reports, the
        doctors will tell you when you need to visit next (generally between 1-3
        months).{" "}
      </div>
    ),
  },
  {
    ...
    contents: (
      <div>
        ...
        do carry reports with you, if available.
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    contents: (
      <div>
        ...
        has failed & what progressive techniques can be used in your case to
        achieve success in IVF.{" "}
      </div>
    ),
  },
];
