          ...
          <div className='px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center'>
            <div>
              ...
              <p className='mt-3 text-brandDark sm:mt-5 text-md sm:text-xl font-content'>
                ...
                ಫರ್ಟಿಲಿಟಿ ತಜ್ಞೆಯಾದ ಡಾ. ಆಶಾ ಎಸ್‌. ವಿಜಯ್‌ ಅವರ ನೇತೃತ್ವದಲ್ಲಿ ಖ್ಯಾತ
                ಉದ್ಯಮಿಗಳು ಮತ್ತು ನುರಿತ ವೈದ್ಯರ ತಂಡವೊಂದು ಗರ್ಭಗುಡಿಯನ್ನ ಸ್ಥಾಪಿಸಿದ್ದು
                ಅದು ಕರ್ನಾಟಕದಾದ್ಯಂತ ಇಂದು ಮನೆಮಾತಾಗಿದೆ.
              </p>
            </div>
          </div>
