...
const Band = () => {
  return (
    <div className="px-3 mx-auto my-4 border-b border-gray-300 max-w-7xl sm:px-6 lg:px-4 ">
      <span className="block mx-auto text-xl font-bold text-center md:text-2xl font-benne">
