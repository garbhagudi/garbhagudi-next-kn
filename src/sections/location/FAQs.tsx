          ...
          <div className="divide-y divide-gray-700 dark:divide-gray-600">
            ...
            <div className="space-y-2 py-6 md:grid md:grid-cols-12 md:gap-8 md:space-y-0">
              ...
              <div className="md:col-span-8 md:pl-0">
                ...
                ಆರೋಗ್ಯದ ಮೇಲೂ ನಿರ್ಧಾರವಾಗುತ್ತದೆ. ದಾವಣೆಗೆರೆಯಲ್ಲಿ IVF ದರ ರೂ.
                1,50,000 ದಿಂದ ಆರಂಭವಾಗುತ್ತದೆ. ನಮ್ಮ ಪಲವತ್ತತೆ ತಜ್ಞರನ್ನು ಭೇಟಿ ಮಾಡಿ
                ಅವರ ಜೊತೆ ಚರ್ಚಿಸಿ ಸರಿಯಾದ ವೆಚ್ಚ, ಇತರೆ ವೆಚ್ಚ ಎಲ್ಲದರ
                ಮಾಹಿತಿ ಪಡೆಯಬಹುದು.
              </div>
            </div>
          </div>
